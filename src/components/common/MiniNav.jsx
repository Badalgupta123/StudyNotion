...
const MiniNav= ({handleHamburger, isClose}) =>{
  ...
  >
    ...
    <div className= {`flex flex-col ${
      ...
      <div className="items-center gap-y-2 flex flex-col">
        ...
        {token === null && (
          <Link to="/login">
            <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[6px] py-[4px]
      ...
      <nav className="block">
        <ul className="flex flex-col gap-y-2 text-richblack-25">
          ...
          <div className={` ${token !== null && user?.accountType === ACCOUNT_TYPE.STUDENT ? "mt-3" : "-mt-3"  }
           w-[90%]  h-[1px] bg-richblack-700 `}></div>
          {
            token !== null && (
              <>
                ...
                <button
                  ...
                  className={` ${token !== null && user?.accountType === ACCOUNT_TYPE.STUDENT ?
                   "mr-16" : "mr-8"  }`}
                >
              ...
              {link.title === "Catalog" ? (
                <>
                  ...
                  >
                    <p>{link.title}</p>
                    <BsChevronDown />
                    <div className="invisible absolute left-[50%] top-[50%] z-[1000] flex w-[100px] 
